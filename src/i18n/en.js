...
const en = {
  ...
  whiteboard: {
    ...
    locked_board:
      'The teacher is moving the whiteboard. Please do not draw on it.',
  ...
  device: {
    ...
    test_microphone:
      'What to say to the microphone, check if the microphone is normal',
  },
  nav: {
    delay: 'Delay: ',
    network: 'Network: ',
  ...
  home: {
    ...
    short_title: {
      ...
      subtitle:
        'Powered by agora.io, a leading online learning engagement platform',
    },
  ...
  assistant: {
    ...
    data_null_text:
      'There is no class currently in session, you can refresh or exit the interface',
    refresh: 'refresh',
    exit: 'exit',
  },
